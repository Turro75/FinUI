...
LD_PRELOAD=/mnt/sdcard/.system/rg35xx/lib/libSDL-1.2.so.0.11.4 retroarch.elf -v --config ${RA_HOME}/retroarch.cfg --appendconfig "${CORES_PATH}/specialcfg.cfg" -L "$CORES_PATH/${EMU_EXE}_libretro.so" "$ROM" &> "$LOGS_PATH/$EMU_TAG.txt"
